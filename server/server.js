...
const associati = [
    "Carlo Tedesco", "Nicola Maino", "Miki Braná",
    "Filippo Tafuni", "Bartolo Diele", "Antonio Petrara",
    "Michele Farella", "Marcantonio Dambrosio", "Carlo Traetta",
    "Francesco Perrucci", "Michele Picerno", "Antonio Clemente",
    "Pasquale Tamborra", "Vincenzo Rotunno", "Michele Ardino",
    "Sandro Squicciarini", "Antonio Robortella", "Giacomo Caserta",
    "Vincenzo Cisterna", "Antonio Denora", "Francesco Tafuni", "Leonardo Di noya",
    "Domenico Carone", "Antonio Miglionico", "Vincenzo Cicirelli",
    "Giuseppe Baldini Anastasio", "Michele Morgese", "Andrea Lauriero",
    "Nicola Colonna", "Michele Caggiano", "Eleonora Varone",
    "Tommaso Rinaldi", "Angelo Tragni", "Lorenzo Tritto", "Giovanni Ragone",
    "Saverio Leone", "Angelo Ostuni", "Pasquale Tragni", "Stefano Maggio",
    "Claudio Lanza", "Paolo Colonna", "Vito Tafuno", "Giuseppe Monitillo",
    "Pietro Colonna", "Giovanni Pepe", "Denny Lorusso",
    "Antonio Picerno", "Adriano Rizzo"
];
